...
{
	static const QScreen * screen = QGuiApplication::primaryScreen();
	static const int       xMax   = screen != nullptr ? screen->availableSize().width() : 1680;
	static const int       width  = SIZE * xMax / 1680 / 4 * 4;
