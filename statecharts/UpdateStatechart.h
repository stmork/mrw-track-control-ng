...
namespace mrw
{
	namespace statechart
	{
		...
		class UpdateStatechart : public QObject, public sc::timer::TimedInterface, public std::enable_shared_from_this<sc::timer::TimedInterface>, public sc::EventDrivenInterface
		{
			Q_OBJECT

		public:
			explicit UpdateStatechart(QObject * parent) noexcept;
			...
			*/
			...
			static constexpr sc::integer timeEventsCount {9};
