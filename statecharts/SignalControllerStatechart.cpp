...
namespace mrw
{
	namespace statechart
	{
		...
		SignalControllerStatechart::SignalControllerStatechart(QObject * parent) noexcept :
		...
		{
			std::fill(std::begin(stateConfVector), std::end(stateConfVector), mrw::statechart::SignalControllerStatechart::State::NO_STATE);
			clearInEvents();
		}
		...
		std::unique_ptr<mrw::statechart::SignalControllerStatechart::EventInstance> SignalControllerStatechart::getNextEvent() noexcept
		{
			std::unique_ptr<mrw::statechart::SignalControllerStatechart::EventInstance> nextEvent = nullptr;
		...
		bool SignalControllerStatechart::dispatchEvent(std::unique_ptr<mrw::statechart::SignalControllerStatechart::EventInstance> event) noexcept
		{
			if (event == nullptr)
			{
				return false;
		...
		{
			incomingEventQueue.push_back(std::unique_ptr<mrw::statechart::SignalControllerStatechart::EventInstance>(new mrw::statechart::SignalControllerStatechart::EventInstance(mrw::statechart::SignalControllerStatechart::Event::start)));
			runCycle();
		}
		...
		{
			incomingEventQueue.push_back(std::unique_ptr<mrw::statechart::SignalControllerStatechart::EventInstance>(new mrw::statechart::SignalControllerStatechart::EventInstance(mrw::statechart::SignalControllerStatechart::Event::clear)));
			runCycle();
		}
		...
		{
			incomingEventQueue.push_back(std::unique_ptr<mrw::statechart::SignalControllerStatechart::EventInstance>(new mrw::statechart::SignalControllerStatechart::EventInstance(mrw::statechart::SignalControllerStatechart::Event::failed)));
			runCycle();
		}
		...
		{
			incomingEventQueue.push_back(std::unique_ptr<mrw::statechart::SignalControllerStatechart::EventInstance>(new mrw::statechart::SignalControllerStatechart::EventInstance(mrw::statechart::SignalControllerStatechart::Event::enable)));
			runCycle();
		}


		/*! Slot for the in event 'extend' that is defined in the default interface scope. */
		void mrw::statechart::SignalControllerStatechart::extend()
		{
			incomingEventQueue.push_back(std::unique_ptr<mrw::statechart::SignalControllerStatechart::EventInstance>(new mrw::statechart::SignalControllerStatechart::EventInstance(mrw::statechart::SignalControllerStatechart::Event::extend)));
			runCycle();
		}
		...
		{
			incomingEventQueue.push_back(std::unique_ptr<mrw::statechart::SignalControllerStatechart::EventInstance>(new mrw::statechart::SignalControllerStatechart::EventInstance(mrw::statechart::SignalControllerStatechart::Event::disable)));
			runCycle();
		}
		...
		{
			incomingEventQueue.push_back(std::unique_ptr<mrw::statechart::SignalControllerStatechart::EventInstance>(new mrw::statechart::SignalControllerStatechart::EventInstance(mrw::statechart::SignalControllerStatechart::Event::completedMain)));
			runCycle();
		}
		...
		{
			incomingEventQueue.push_back(std::unique_ptr<mrw::statechart::SignalControllerStatechart::EventInstance>(new mrw::statechart::SignalControllerStatechart::EventInstance(mrw::statechart::SignalControllerStatechart::Event::completedDistant)));
			runCycle();
		}
		...
		{
			incomingEventQueue.push_back(std::unique_ptr<mrw::statechart::SignalControllerStatechart::EventInstance>(new mrw::statechart::SignalControllerStatechart::EventInstance(mrw::statechart::SignalControllerStatechart::Event::completedShunt)));
			runCycle();
		}



		bool SignalControllerStatechart::isActive() const noexcept
		{
		 ...
		 */
		bool SignalControllerStatechart::isFinal() const noexcept
		{
			return false;
		}

		bool SignalControllerStatechart::check() const noexcept
		{
		...
		void SignalControllerStatechart::setTimerService(std::shared_ptr<sc::timer::TimerServiceInterface> timerService_) noexcept
		{
			this->timerService = timerService_;
		}

		std::shared_ptr<sc::timer::TimerServiceInterface> SignalControllerStatechart::getTimerService() noexcept
		{
			return timerService;
		}

		sc::integer SignalControllerStatechart::getNumberOfParallelTimeEvents() noexcept
		{
		...
		bool SignalControllerStatechart::isStateActive(State state) const noexcept
		{
			switch (state)
			{
		...
		sc::integer SignalControllerStatechart::getTimeout() noexcept
		{
			return timeout;
		}

		sc::integer SignalControllerStatechart::getDelay() noexcept
		{
			return delay;
		}

		sc::integer SignalControllerStatechart::getSymbol() const noexcept
		{
			return symbol;
		}

		void SignalControllerStatechart::setSymbol(sc::integer symbol_) noexcept
		{
			this->symbol = symbol_;
		}
		sc::integer SignalControllerStatechart::getOFF() noexcept
		{
			return OFF;
		}

		sc::integer SignalControllerStatechart::getSTOP() noexcept
		{
			return STOP;
		}

		sc::integer SignalControllerStatechart::getGO() noexcept
		{
			return GO;
		}

		void SignalControllerStatechart::setOperationCallback(std::shared_ptr<OperationCallback> operationCallback) noexcept
		{
...
// implementations of all internal functions
		...
		{
			/* Entry action for state 'Turn'. */
			emit turnMain(SignalControllerStatechart::STOP);
		}

		void SignalControllerStatechart::enact_main_region_Init_Init_process_Turning_main_Completed()
		{
			completed = true;
		}
		...
		void SignalControllerStatechart::enact_main_region_Init_Init_process_Turning_distant_Turn()
		{
			...
			{
				emit turnDistant(SignalControllerStatechart::STOP);
			}
			if (ifaceOperationCallback->hasMainSignal())
			{
				emit turnDistant(SignalControllerStatechart::OFF);
			}
		}

		void SignalControllerStatechart::enact_main_region_Init_Init_process_Turning_distant_Completed()
		{
			completed = true;
		}
		...
		void SignalControllerStatechart::enact_main_region_Init_Init_process_Turning_shunt_Turn()
		{
			...
			{
				emit turnShunt(SignalControllerStatechart::STOP);
			}
			if (ifaceOperationCallback->isMainAndShunt())
			{
				incomingEventQueue.push_back(std::unique_ptr<mrw::statechart::SignalControllerStatechart::EventInstance>(new mrw::statechart::SignalControllerStatechart::EventInstance(mrw::statechart::SignalControllerStatechart::Event::completedShunt)));
		...
		void SignalControllerStatechart::enact_main_region_Init_Init_process_Turning_shunt_Completed()
		{
			completed = true;
		}
		...
		{
			/* 'default' enter sequence for state Completed */
			enact_main_region_Init_Init_process_Turning_main_Completed();
		...
		{
			/* 'default' enter sequence for state Completed */
			enact_main_region_Init_Init_process_Turning_distant_Completed();
		...
		{
			/* 'default' enter sequence for state Completed */
			enact_main_region_Init_Init_process_Turning_shunt_Completed();
		...
		/* 'mrw.statechart.SignalControllerStatechart.main_region.Operating.Processing.Tour_State.Processing.Waiting' enter sequence for state Waiting */
		void SignalControllerStatechart::enseq_main_region_Operating_Processing_Tour_State_Processing_Waiting_mrw_statechart_SignalControllerStatechart_main_region_Operating_Processing_Tour_State_Processing_Waiting()
		{
			/* 'mrw.statechart.SignalControllerStatechart.main_region.Operating.Processing.Tour_State.Processing.Waiting' enter sequence for state Waiting */
			stateConfVector[0] = mrw::statechart::SignalControllerStatechart::State::main_region_Operating_Processing_Tour_State_Processing_Waiting;
			stateConfVectorPosition = 0;
		}
		...
		/* 'mrw.statechart.SignalControllerStatechart.main_region.Operating.Processing.Pending' enter sequence for state Pending */
		void SignalControllerStatechart::enseq_main_region_Operating_Processing_Pending_mrw_statechart_SignalControllerStatechart_main_region_Operating_Processing_Pending()
		{
			/* 'mrw.statechart.SignalControllerStatechart.main_region.Operating.Processing.Pending' enter sequence for state Pending */
			stateConfVector[0] = mrw::statechart::SignalControllerStatechart::State::main_region_Operating_Processing_Pending;
			stateConfVectorPosition = 0;
		}
		...
		{
			/* Default exit sequence for state Turn */
			stateConfVector[0] = mrw::statechart::SignalControllerStatechart::State::main_region_Init_Init_process_Turning;
			stateConfVectorPosition = 0;
		}
		...
		{
			/* Default exit sequence for state Turn */
			stateConfVector[1] = mrw::statechart::SignalControllerStatechart::State::main_region_Init_Init_process_Turning;
			stateConfVectorPosition = 1;
		}
		...
		{
			/* Default exit sequence for state Turn */
			stateConfVector[2] = mrw::statechart::SignalControllerStatechart::State::main_region_Init_Init_process_Turning;
			stateConfVectorPosition = 2;
		}
		...
		{
			/* Default exit sequence for state Unlocked */
			stateConfVector[0] = mrw::statechart::SignalControllerStatechart::State::main_region_Operating;
			stateConfVectorPosition = 0;
		}
		...
		{
			/* Default exit sequence for state Idle */
			stateConfVector[0] = mrw::statechart::SignalControllerStatechart::State::main_region_Operating_Processing_Shunting_State;
			stateConfVectorPosition = 0;
		}
		...
		{
			/* Default exit sequence for state Extend */
			stateConfVector[0] = mrw::statechart::SignalControllerStatechart::State::main_region_Operating_Processing_Shunting_State_Processing_Waiting;
			stateConfVectorPosition = 0;
		}
		...
		void SignalControllerStatechart::exseq_main_region_Operating_Processing_Tour_State_Processing_Waiting()
		{
			...
			stateConfVector[0] = mrw::statechart::SignalControllerStatechart::State::main_region_Operating_Processing_Tour_State;
			stateConfVectorPosition = 0;
		...
		sc::integer SignalControllerStatechart::main_region_Init_Init_process_Turning_main_Completed_react(const sc::integer transitioned_before)
		{
			...
			sc::integer transitioned_after = transitioned_before;
			if ((isStateActive(mrw::statechart::SignalControllerStatechart::State::main_region_Init_Init_process_Turning_shunt_Completed)) && ((isStateActive(mrw::statechart::SignalControllerStatechart::State::main_region_Init_Init_process_Turning_distant_Completed)) && ((isStateActive(mrw::statechart::SignalControllerStatechart::State::main_region_Init_Init_process_Turning_main_Completed)) && (doCompletion))))
			{
				...
				stateConfVector[0] = mrw::statechart::SignalControllerStatechart::State::main_region_Init;
				stateConfVector[1] = mrw::statechart::SignalControllerStatechart::State::main_region_Init;
				stateConfVector[2] = mrw::statechart::SignalControllerStatechart::State::main_region_Init;
				stateConfVectorPosition = 2;
				/* The reactions of state null. */
				exseq_main_region_Init();
		...
		sc::integer SignalControllerStatechart::main_region_Operating_Processing_Unlocked_react(const sc::integer transitioned_before)
		{
			...
			if (!(doCompletion))
			{
				if ((transitioned_after) < (0))
				{
					...
					{
						exseq_main_region_Operating_Processing_Unlocked();
						enseq_main_region_Operating_Processing_Pending_mrw_statechart_SignalControllerStatechart_main_region_Operating_Processing_Pending();
		...
		sc::integer SignalControllerStatechart::main_region_Operating_Processing_Shunting_State_Processing_Idle_react(const sc::integer transitioned_before)
		{
			...
			if (!(doCompletion))
			{
				if ((transitioned_after) < (0))
				{
					...
					{
						exseq_main_region_Operating_Processing_Shunting_State_Processing_Idle();
						setSymbol(SignalControllerStatechart::STOP);
			...
			if (!(doCompletion))
			{
				if ((transitioned_after) < (0))
				{
					if (disable_raised)
					{
						exseq_main_region_Operating_Processing_Tour_State_Processing_Idle();
						setSymbol(SignalControllerStatechart::STOP);
						enseq_main_region_Operating_Processing_Tour_State_Processing_Waiting_mrw_statechart_SignalControllerStatechart_main_region_Operating_Processing_Tour_State_Processing_Waiting();
		...
		void SignalControllerStatechart::clearInEvents() noexcept
		{
			start_raised = false;
			clear_raised = false;
			failed_raised = false;
