...
namespace mrw
{
	namespace statechart
	{
		...
		class SignalControllerStatechart : public sc::timer::TimedInterface, public sc::EventDrivenInterface
		{
		public:
			SignalControllerStatechart() noexcept;
			...
			*/
			...
			static constexpr sc::integer timeEventsCount {6};

			//! number of time events that can be active at once.
			static constexpr sc::integer parallelTimeEventsCount {2};
		...
		private:
			...
			static constexpr sc::ushort maxOrthogonalStates {3};
